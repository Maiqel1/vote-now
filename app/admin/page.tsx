        ...
        <div className="glass rounded-2xl p-7 space-y-4 animate-slide-up delay-200">
          ...
          <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/60 border border-border">
            ...
            <button
              onClick={sendEmails}
              // disabled
              className="flex-shrink-0 ml-4 flex items-center gap-2 px-4 py-2 rounded-xl bg-amber-500/20 text-amber-400/50 text-xs font-medium font-sans border border-amber-500/15"
            >
              <svg
                width="13"
                height="13"
